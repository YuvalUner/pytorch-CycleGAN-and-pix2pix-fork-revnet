...
class RevnetGanModel(BaseModel):
    """
    This class implements the RevnetGan model, for learning image to image translation without paired data.
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_D = torch.optim.Adam(itertools.chain(self.netD_A.parameters()), lr=opt.lr,
                                                betas=(opt.beta1, 0.999))
    ...
    def forward(self):
        ...
        self.fake_A = self.netG.module.BtoA(self.real_B)  # G_A(B) - reverse direction
